...
import { createUserController, loginUserController, listAlluserController, ListCoursesUserController } from "../../controllers";
...
usersRoute.get("/:id/courses", verifyUserId, verifyToken, validatePermission, ListCoursesUserController)